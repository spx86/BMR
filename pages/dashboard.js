    ...
    render() {
        return (
            <Layout>
                ...
                <Card.Group centered itemsPerRow='2'>
                  <Card color={this.props.patGrowthColor}>
                      <Card.Content>
                          ...
                          />
                          <Card.Header>月度患者增长</Card.Header>
                      </Card.Content>
                      <Card.Content extra>
                  ...
                  <Card color={this.props.apptGrowthColor}>
                      <Card.Content>
                          <Image
                              ...
                              src='https://cdn-icons-png.flaticon.com/512/858/858736.png'
                          />
                          <Card.Header>月度会诊增长</Card.Header>
                      </Card.Content>
                      <Card.Content extra>
                ...
                <Card.Group centered itemsPerRow='4'>
                    <Card>
                        <Card.Content>
                            ...
                            />
                            <Card.Header>患者记录数量</Card.Header>
                        </Card.Content>
                        <Card.Content extra>
                    ...
                    <Card>
                        <Card.Content>
                            ...
                            />
                            <Card.Header>授权许可数量</Card.Header>
                        </Card.Content>
                        <Card.Content extra>
                        <Statistic size='small'>
                ...
                <Segment padded>
                    <h3 style={{textAlign: "center"}}>2023年医师与患者数量对比</h3>
                ...
                <Segment padded>
                  <h3 style={{textAlign: "center"}}>2023年患者会诊数量</h3>
                  <ResponsiveContainer width="100%" aspect={3}>
                      <LineChart
                      width={500}
                      height={300}
                ...
                <Segment padded>
                    <h3 style={{textAlign: "center"}}>单个患者会诊数量</h3>
